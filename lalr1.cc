...
m4_ifdef ([[b4_dmw_yys_noptr]],
[[ m4_define([[b4_dmw_yysptr]], [[]])   ]],
[[ m4_define([[b4_dmw_yysptr]], [[*]]) ]])
...
[[    typedef YYSTYPE semantic_type;]])])[
    ...
    /// Token name.
    /// \returns  token name given id
    static const char * token_name(int token_id)
      { return yytname_[yytranslate_(token_id)]; }
...
m4_popdef([b4_at_dollar])])dnl
  ...
  yybackup:
	...
	yychar = ]b4_c_function_call([yylex], [int],
                     [[YYSTYPE b4_dmw_yysptr], [&yylval]][]dnl
